<div class="position-fixed course-options-menu pb-4 d-md-none">
    <div class="row pt-3">
        <div class="col-12">
            <a class="text-decoration-none edit-course text-white px-4 pb-3" href=""><i class="text-white mr-2 fa fa-pencil" aria-hidden="true"></i>edit course</a>
        </div>

        <div class="col-12">
            <form class="delete-course-form" action="" method="post">
                {{csrf_field()}}
