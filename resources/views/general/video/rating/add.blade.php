                    ...
                    <div class="col-12 col-md-4 mt-4">
                        <div class="content-rating">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="form-check pl-2">
                                    <input class="form-check-input star-input" type="radio" name="content" id="content2stars" value="2">
                                    <label class="form-check-label" for="content2stars"><span class="star"><i class="fa fa-star"></i></span></label>
                                </div>
                                <div class="form-check pl-2">
                                    <input class="form-check-input star-input" type="radio" name="content" id="content3stars" value="3">
                                    <label class="form-check-label" for="content3stars"><span class="star"><i class="fa fa-star"></i></span></label>
                                </div>
                                <div class="form-check pl-2">
                                    <input class="form-check-input star-input" type="radio" name="content" id="content4stars" value="4">
                                    <label class="form-check-label" for="content4stars"><span class="star"><i class="fa fa-star"></i></span></label>
                                </div>
                                <div class="form-check pl-2">
                                    <input class="form-check-input star-input" type="radio" name="content" id="content5stars" value="5">
                        ...
                        <div class="quality-rating mt-4">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="form-check pl-2">
                                    <input class="form-check-input star-input" type="radio" name="quality" id="quality2star" value="2">
                                    <label class="form-check-label" for="quality2star"><span class="star"><i class="fa fa-star"></i></span></label>
                                </div>
                                <div class="form-check pl-2">
                                    <input class="form-check-input star-input" type="radio" name="quality" id="quality3star" value="3">
                                    <label class="form-check-label" for="quality3star"><span class="star"><i class="fa fa-star"></i></span></label>
                                </div>
                                <div class="form-check pl-2">
                                    <input class="form-check-input star-input" type="radio" name="quality" id="quality4star" value="4">
                                    <label class="form-check-label" for="quality4star"><span class="star"><i class="fa fa-star"></i></span></label>
                                </div>
                                <div class="form-check pl-2">
                                    <input class="form-check-input star-input" type="radio" name="quality" id="quality5star" value="5">
